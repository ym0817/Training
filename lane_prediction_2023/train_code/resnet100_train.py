...
from resnetv2 import ResNet101
...
def main(args):
    ...
    net = ResNet101(num_classes=64)
    backbone_type = 'resnet100_lane_'

    net.load_state_dict(torch.load('/media/ym/DATA1/Arhud_Prediction/lane_prediction_2023/train_code/checkpoints_res100_41_407/resnet100_lane_0410_0935/epoch42_model.pth'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default='./checkpoints_res100_41_420', help='model save dir')
