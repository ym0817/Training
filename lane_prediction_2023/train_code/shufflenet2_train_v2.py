...
import numpy as np
from lane_dataset_v2 import Dataset
from tensorboard_gp import TensorBoard
# from backbone.shufflenet import ShuffleNetV2_MetaACON
# from backbone.MobileNetV2 import mobilenet_v2
from datetime import datetime
# from resnetv2 import ResNet18
# from mobilenetv2 import mobile_half
from lane_ShuffleNetv2 import ShuffleV2
...
def main(args):
    ...
    # net = net = mobile_half(64)
    net = ShuffleV2(num_classes=64)
    backbone_type = 'shufflenet2_lane_'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--file_list', type=str, default='/media/ym/DATA1/Arhud_Prediction/DataProcess/lane_csvfiles', help='train list')
    parser.add_argument('--gpus', type=str, default='-1', help='model prefix')
    parser.add_argument('--train_batchsize', type=int, default=64, help='batch size')
    ...
    parser.add_argument('--save_dir', type=str, default='./checkpoints_41_407', help='model save dir')
    # parser.add_argument('--pad', type=bool, default=True, help=' wether image is paded')




    # parser.add_argument('--margin_type', type=str, default='ArcFace', help='ArcFace, Subcenter, NPCFace')
    # parser.add_argument('--feature_dim', type=int, default=512, help='feature dimension, 128 or 512')
    # parser.add_argument('--scale_size', type=float, default=30.0, help='scale size')
    # parser.add_argument('--margin_size', type=float, default=0.40, help='margin size')
    # parser.add_argument('--batch_size', type=int, default=200, help='batch size')
    #
    #
    # parser.add_argument('--save_freq', type=int, default=4000, help='save frequency')
    # parser.add_argument('--resume', type=int, default=False, help='resume model')
    # parser.add_argument('--net_path', type=str, default='./checkpoints/best_net.ckpt', help='resume model')
    # parser.add_argument('--margin_path', type=str, default='./checkpoints/best_margin.ckpt', help='resume model')
    #
    # parser.add_argument('--model_pre', type=str, default='baseline_arcface_msv3_mb_', help='model prefix')
