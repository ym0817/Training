...
from obj_ShuffleNetv3 import ShuffleV2
...
def main(args):
    ...
    backbone_type = 'object_shufflenet3_'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default='./checkpoints_sf3', help='model save dir')
