...
from obj_ShuffleNetv2 import ShuffleV2
...
def main(args):
    ...
    net = ShuffleV2(num_classes=8)

    # net = net = mobile_half(8)
    backbone_type = 'object_shufflenet_'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default='./checkpoints_41_417', help='model save dir')
